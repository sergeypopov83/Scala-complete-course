...
object CurriedComputation extends App with Data {
  ...
  def curriedComputation(filterData: String)(dataProducer: Array[String]): Array[String] =  dataProducer.filter(dataItem => filterData.contains(dataItem))
...
object FunctionalComputation extends App with Data {
  ...
  def functionalComputation(filterData: String): Array[String] => Array[String] = (dataProducer: Array[String]) => dataProducer.filter(dataItem => filterData.contains(dataItem))
