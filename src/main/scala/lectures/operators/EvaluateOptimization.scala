...
import lectures.functions.Computation.{dataArray, filterData}
import lectures.functions.CurriedComputation.dataArray
import lectures.functions.FunctionalComputation.dataArray
